  ...
  class Contact extends Component {
    ...
    async componentDidMount() {
      ...
      const { ip_addr, user_agent } = await fetch(`https://ifconfig.me/all.json`).then(r => r.json())

      await fetch(`https://geo.ivorpad.com/geo`, {
        method: 'post',
        body: JSON.stringify({ ip: ip_addr, userAgent: user_agent }),
        headers: {
    ...
    handleForm = e => {
      ...
      fetch(
        `https://l21mtijege.execute-api.us-west-2.amazonaws.com/prod/static-site-mailer`,
        {
          method: 'post',
